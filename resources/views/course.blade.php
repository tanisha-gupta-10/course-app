...
<x-app-layout>
    ...
    <section id="courses" class="mt-4 container">
        <span class="head-text text-center w-100 d-flex justify-center">Courses</span>

        <div class="courses">

            <div class="section_text">
                <span class="head-text">{{ $course->title }}</span>
                <span class="sub-text">{{ $course->description }}</span>


            </div>

            <a class="card" href="{{ route('course', ['course_id' => $course->id]) }}">
